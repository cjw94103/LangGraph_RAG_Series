...
from core.self_route import SelfRoute
...
if process:
    ...
    graph_ins = SelfRoute(retriever=retriever, top_k=st.session_state.top_k)
...
if conver_init:
    ...
    thread_id = str(uuid.uuid4())
    graph_ins = SelfRoute(retriever=st.session_state.retriever, top_k=st.session_state.top_k)
    app = graph_ins.make_app_graph()
