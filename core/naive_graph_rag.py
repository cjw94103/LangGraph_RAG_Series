...
from utils.helper import openai_api_setting, make_uploadfile_to_graph_retriever_neo4j
...
class NaiveGraphRAG:
    def __init__(self, graph_retriever, top_k=5):
        self.graph_retriever = graph_retriever
        self.graph_retriever.search_kwargs["k"] = top_k
    ...
    def retrieve_documents(self, state : GraphState, config : RunnableConfig):
        ...
        retrieve_results = self.graph_retriever.invoke(question)
